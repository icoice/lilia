...
httpMethods.map(function (name) {
  httpMethodCreator[name] = function (n) {
    var api = (0, _createApi2.default)('GET', n);
    undefined.config.access[name] = api.config;
    return api;
  };
});
...
exports.default = (0, _extends3.default)({
  ...
  bindPublicEvent: function bindPublicEvent(serves) {
    ...
    serves.map(function (serve) {
      serves.ON_REQUEST_ERROR(_this.ORERR);
      serves.ON_REQUEST_EXCEPTION(_this.ORERR);
      serves.ON_REQUEST(_this.OR);
    });
  },
