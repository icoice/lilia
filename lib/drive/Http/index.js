...
exports.default = function (params) {
  ...
  var onBuildPayload = params.setPayload;
  var onBuildHeaders = params.setHeaders;
  ...
  var apiParams = {
    ...
    replaceSender: replaceSender, // 替换发送体
    fakeDelayTime: fakeDelay };

  var serve = (0, _create2.default)(apiParams);
  var mecha = new _mecha2.default(serve); // 针对http协议的夹层
