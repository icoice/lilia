...
var firstUppercase = _util2.default.String.firstUppercase;

exports.default = function (name, state) {
  ...
  return {
    ...
    data: function data() {
      ...
      (0, _entries2.default)($data).map(function (kv) {
        ...
        newData['' + name + firstUppercase(k)] = _this[k];
        return kv;
      });
