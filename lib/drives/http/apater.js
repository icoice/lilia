...
var _http = require('../drives/http');

var _http2 = _interopRequireDefault(_http);

var _mecha = require('../drives/http/mecha');
...
exports.default = function (params) {
  ...
  var access = list.map(function (api) {
    return (0, _assign2.default)({ fake: fake }, {
  ...
  var mecha = new _mecha2.default((0, _http2.default)(apiParams)); // 针对http协议的夹层
