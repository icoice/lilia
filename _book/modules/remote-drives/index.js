 ...
 */
 class Remote {
  constructor(setting = {}) {
    ...
    this.fakeDelayTime = typeof fakeDelayTime === 'number' ? fakeDelayTime : 1000;
    return this.set(setting);
  }
  // 配置Remote实例
  set(setting = {}) {
    this.domain = setting.domain ? setting.domain : '';
    this.access = setting.access ? setting.access : [];
...
export default function (setting) {
  ...
  return new Adapter(new Remote(access.map(api=> Object.assign(api, {
    config: {},
    headers: {},
    request: {},
    status: 200,
